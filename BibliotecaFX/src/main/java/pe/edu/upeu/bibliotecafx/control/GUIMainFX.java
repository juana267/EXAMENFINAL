...
import pe.edu.upeu.bibliotecafx.servicio.MenuMenuItemDao;
import pe.edu.upeu.bibliotecafx.servicio.MenuMenuItenDaoI;
import pe.edu.upeu.bibliotecafx.utils.UtilsX;
...
// Layout principal
    ...
    class MenuItemListener {
        public void handle(javafx.event.ActionEvent e) {
            ...
            if (((MenuItem) e.getSource()).getId().equals("mimireglibro")) {
                tabPaneFx.getTabs().clear();
                FXMLLoader loader = new
                        FXMLLoader(getClass().getResource("/view/libro.fxml"));
                ...
                try {
                    ...
                    //mc.setContexto(ctx);
                    Tab clienteTab = new Tab("Reg. Libro",dd );
            ...
            if (((MenuItem) e.getSource()).getId().equals("mimicliente")) {
                tabPaneFx.getTabs().clear();
                FXMLLoader loader = new
                        FXMLLoader(getClass().getResource("/view/cliente.fxml"));
                loader.setControllerFactory(context::getBean);
                Parent paneFromFXML;
                try {
                    paneFromFXML = loader.load(); // Cargar el contenido FXML
            ...
            if(((MenuItem) e.getSource()).getId().equals("mimiventaboleta")){
                tabPaneFx.getTabs().clear();
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/boleta.fxml"));
                loader.setControllerFactory(context::getBean);
                Parent paneFromFXML;
                try {
                    paneFromFXML = loader.load(); // Cargar el contenido FXML
                    ScrollPane dd= new ScrollPane(paneFromFXML);
                    //mc.setContexto(ctx);
                    Tab clienteTab = new Tab("Registro Boleta",dd );
                    tabPaneFx.getTabs().add(clienteTab);
                } catch (IOException ex) {
                    throw new RuntimeException(ex);
                }
            ...
            if(((MenuItem) e.getSource()).getId().equals("mimiventafactura")){
                tabPaneFx.getTabs().clear();
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/factura.fxml"));
                loader.setControllerFactory(context::getBean);
                Parent paneFromFXML;
                try {
                    paneFromFXML = loader.load(); // Cargar el contenido FXML
                    ScrollPane dd= new ScrollPane(paneFromFXML);
                    //mc.setContexto(ctx);
                    Tab clienteTab = new Tab("Registro Factura",dd );
                    tabPaneFx.getTabs().add(clienteTab);
                } catch (IOException ex) {
                    throw new RuntimeException(ex);
                }
            ...
            if(((MenuItem) e.getSource()).getId().equals("mimiusuarios")){
                tabPaneFx.getTabs().clear();
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/main_confirmacionRegistro.fxml"));
                loader.setControllerFactory(context::getBean);
                Parent paneFromFXML;
                try {
                    paneFromFXML = loader.load(); // Cargar el contenido FXML
                    ScrollPane dd= new ScrollPane(paneFromFXML);
                    //mc.setContexto(ctx);
                    Tab clienteTab = new Tab("Con. Usuarios",dd );
                    tabPaneFx.getTabs().add(clienteTab);
                } catch (IOException ex) {
                    throw new RuntimeException(ex);
                }
